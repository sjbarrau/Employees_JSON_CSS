		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#comaccenturemisempleados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaccenturemisempleados-display": {
								"semanticObject": "comaccenturemisempleados",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.accenture.misempleados",
									"url": sap.ui.require.toUrl("com/accenture/misempleados")
								}
							}
						}
					}
